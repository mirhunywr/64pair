            ...
            sock.ev.on("connection.update", async (s) => {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "blinder~" + base64Session;
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        
                        let desc = `*Hey there, QADEER-AI User!* 👋🏻
...
> *© Powered by QadeerXTech💫*
By Order of the QadeerXTech 😁☠️`;
                        
                        await sock.sendMessage(sock.user.id, {
                            text: desc,
                            contextInfo: {
                                externalAdReply: {
                                    title: "ϙᴀᴅᴇᴇʀ ᴀɪ 𝕮𝖔𝖓𝖓𝖊𝖈𝖙𝖊𝖉",
...
By Order of the Peaky blinders  🔱⚜️*`;
    ...
    await PEAKY_BLINDER_MD_PAIR_CODE();
});
